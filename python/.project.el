`(:project-tags ("python_bdd_project_template")
		...
		:roam-templates (("s" "Idea" plain
				  "${title}"
				  :target (file "~/kingdom/projects/solo-projects/professional-projects/repo-templates/python-bdd-project-template/bdd/ideas.txt")
				  :empty-lines 1
				  :immediate-finish)
				 ("e" "Story" entry
				  (file "~/kingdom/projects/solo-projects/professional-projects/repo-templates/python-bdd-project-template/bdd/story-template.org")
				  :target (file "~/kingdom/projects/solo-projects/professional-projects/repo-templates/python-bdd-project-template/bdd/stories.org")))
